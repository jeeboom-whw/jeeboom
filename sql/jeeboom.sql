...
CREATE TABLE `sys_area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='地区表';

-- ----------------------------
--  Records of `sys_area`
-- ----------------------------
BEGIN;
INSERT INTO `sys_area` VALUES ('1', '黑龙江省', '0', '1'), ('2', '辽宁省', '0', '1'), ('3', '哈尔滨市', '1', '2'), ('4', '鹤岗市', '1', '2'), ('5', '道里区', '3', '3'), ('6', '道外区', '3', '3'), ('7', '东山区', '4', '3'), ('8', '向阳区', '4', '3'), ('9', '大连市', '2', '2'), ('10', '甘井子区', '9', '3');
COMMIT;
